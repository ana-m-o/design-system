...
describe('OperationStatus component', () => {
    ...
    //        - Muestra el tag con el icono "dx-icon-sand-clock" (también cuando el operation status no tiene la prop showNumbers)
    ...
    //    - Cada stage-item contiene un elemento con clase .dx-tag
    //
