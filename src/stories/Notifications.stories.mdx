...
| **Alert**              | System or product notifications specifics to a task                                                      | It persists until discarded by the user and may include a close button, link to extended information or retry button |
