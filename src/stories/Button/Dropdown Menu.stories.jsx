...
const TemplateIcons = (args) =>
    <Dropdown
        ...
        overlay={
            <Menu>
                <Menu.Item key="1" icon={<span className="dx-icon-deploy"></span>}>
                    1st menu item
                </Menu.Item>
                <Menu.Item key="2" icon={<span className="dx-icon-deploy-rollback"></span>}>
                    2nd menu item
                </Menu.Item>
                <Menu.Item key="3" icon={<span className="dx-icon-redeploy"></span>}>
                    3rd menu item
                </Menu.Item>
                <Menu.Divider />
                <Menu.Item key="4" icon={<span className="dx-icon-deploy-package"></span>} disabled>
