...
+ Included in a toolbar adjacent to the list. They will be specific to one or more records in the list and will be enabled depending on the selected items. 
+ Included within the list, in the same rows. We can find, in lists, toolbars specific to each record that will be included in a column of actions.
